...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item border border-2 border-light mx-1">
            <a class="nav-link text-light active" aria-current="page" href="pmb.php">PENDAFTARAN</a>
          </li>
          
        </ul>
        <form class="d-flex">
          <input class="form-control border-2 border-light me-2" type="search" placeholder="" aria-label="Search">
          <button class="but but-outline-dark border border-2 border-light" type="submit">CARI</button>
        </form>
      </div>
    </div>
  </nav>
  ...
  <div class="container">
    <form action="konfirmasi.php" method="POST">
      <h4 class="text-center mt-4 mb-3">Pendaftaran Mahasiswa Baru Online</h4>
      ...
      <div class="form-group row my-2">
        <label for="namamhsw" class="col-sm-6 col-form-label">Nama Calon Mahasiswa</label>
        <div class="col-sm-6">
          <input class="form-control" type="text" id="namamhsw" name="namamhsw" required>
        </div>
      </div>
      <div class="form-group row my-2">
        <label for="ttl" class="col-sm-6 col-form-label">Tempat dan Tanggal Lahir </label>
        <div class="col-sm-6">
      ...
      <div class="form-group row my-2">
        <label class="col-sm-6 col-form-label">Informasi didapat melalui : </label>
        <div class="col-sm-6">
          <input type="radio" id="internet" value="Internet" name="info">
          <label for="internet">Internet</label><br>
          <input type="radio" id="koran" value="Koran" name="info">
          ...
          <label for="ba-upj">BA UPJ</label><br>
      ...
      <div class="form-group row my-2 border border-2 border-light">
      ...
      <div class="row">
        <div class="col text-center">
          <button type="submit" class="but but-primary bg-primary">Submit</button>
          <button type="reset" class="but but-primary bg-danger">Reset</button>
        </div>
      </div>
    </form>
  </div>
